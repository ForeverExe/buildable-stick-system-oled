...
color("white") translate([-top_plate_x/2-25, 0, frame_z/2+20]) 
    top_panel_hitbox_directions();
color("white") translate([top_plate_x/2+25, 0, frame_z/2+20]) top_panel_right_hitbox_8_buttons();
color("blue") translate([-frame_x/2+5-25, 0, -2.5]) left_frame();
color("blue") translate([frame_x/2+25, 0, -2.5]) right_frame();
color("white") translate([-top_plate_x/2-25, 0, -5-frame_z/2-20]) bottom_panel_left();
color("white") translate([top_plate_x/2+25, 0, -5-frame_z/2-20]) bottom_panel_right();

color("blue") translate([-195, 25, 3+frame_z/2+50]){ 
        dir_arc_24mm_directionals_decorative_plate();
}
color("blue") translate([top_plate_x, 25, 3+frame_z/2+50]){
    translate([-70,-20,0])
